<template>
    <view>
		...
		back-icon-color="#fff"
		:is-fixed='true'
		title="消息" :background="background" :title-color="titleColor"></u-navbar>
        <view class="content">
            <view class="coreshop-content-top">
                <view class='coreshop-cell-group right-img'>
                    <view class='coreshop-cell-item' v-for="(item, i) in msgList" :key="i">
...
<style lang="scss" scoped>
    ...
    .coreshop-cell-hd-title { font-size: 26rpx; /* color: #000000; */ display: block; width: 180rpx; }
    .cell-hd-desc { font-size: 24rpx; /* display: block; */  color: #fff; /* margin-top: 50rpx; */ }
    .subscription-btn { background-color: #02B9EE; color: #ffffff; border-radius: 10rpx; font-size: 24rpx;
	padding: 0 20rpx; line-height: 46rpx;}
    .isTrue { background-color: #59646F; border-radius: 10rpx;color: #333333; line-height: 46rpx; }
</style>