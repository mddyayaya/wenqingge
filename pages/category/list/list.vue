<template>
    <view class="">
		...
		<!-- 轮播 -->
		<view class="cart_banner">
			<swiper class="cart_banner" :indicator-dots="true" :autoplay="true" :interval="3000" :duration="1000">
				<swiper-item>
					<view class="swiper-item images" v-for="item in 3">
						<u-lazy-load threshold="-150" border-radius="0" 
						:image="require('@/static/images/cart/cart_banner.png')"></u-lazy-load>
					</view>
				</swiper-item>
			</swiper>
		</view>
		<view class="cate_wrapper">
			<view class="dashi">
				...
				<view class="dashi_list">
					<view class="dashi_list_item" v-for="item in 4">
						<view class="dashi_pic">
							<u-lazy-load threshold="-150" border-radius="0" 
							:image="require('@/static/images/cart/test_pic.png')"></u-lazy-load>
						</view>
						<view class="dashi_name">
							刘学义
						</view>
					</view>
				</view>
			...
			<view class="u-dropdown">
			    <u-dropdown ref="uDropdown">
			        <u-dropdown-item v-model="comprehensiveDataValue" title="综合排序" :options="comprehensiveData" @change="comprehensive"></u-dropdown-item>
			        <u-dropdown-item v-model="priceSortDataValue" title="全部分类" :options="priceSortData" @change="priceSort"></u-dropdown-item>
			        <u-dropdown-item v-model="salesVolumeDataValue" title="筛选" :options="salesVolumeData" @change="salesVolume"></u-dropdown-item>
								...
								@click="goGoodsDetail(item.id)">
			                        <view class="good_box">
										...
										<view class="good_image">
											...
											height="187"
											imgMode="aspectFit"
											threshold="-150" border-radius="10" :image="item.image" :index="item.id"></u-lazy-load>
										</view>
