<template>
    <view class="memberBox">
                    ...
                    <view class="u-flex user-box u-p-l-30 u-p-r-20 u-p-b-30">
                        ...
                        <view class="u-flex-1 userItem">
                            ...
                            <view class="u-font-24 u-flex-1">
								...
								:size="30"  color="#fff" label-color="#fff" :label="userInfo.point"></u-icon>
                            </view>
                        </view>
                        <!-- #ifndef MP-WEIXIN -->
        ...
        <view class="coreshop-view-content">
            <!--用户数据-->
            <view class="u-p-t-40 coreshop-bg-white u-margin-top-30 coreshop-user-info-tools-box">
            ...
            return {
                ...
                utilityMenus: {
                    myCoupon: {
                        name: '活动预约',
                        icon: 'clock',
                        router: '/pages/member/appoint/appoint',
                        showItem: true
                    },
                    myAddress: {
                        name: '地址管理',
                    ...
                    myQuestion: {
                        name: '反馈建议',
                        icon: 'edit-pen',
                        router: '/pages/member/suggest/suggest',
                        showItem: true
                    },
                    myPrivilege: {
                        name: '我的特权',
