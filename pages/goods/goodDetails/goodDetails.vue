<template>
    <view>
		...
		back-icon-color="#fff"
		:is-back="true"
		title="商品详情" :background="background" :title-color="titleColor"></u-navbar>
        <!--幻灯片-->
		...
		<view class="good_detail_box">
			<view class="good_info_top">
				<view class="price_number_buy">
					<view class="goods_item goods_price">
						￥{{ product.price || '0.00' }}
					</view>
			...
			<view class="good_shop">
				...
				<view class="shop_show_detail" @click="goShop()">
					查询
				</view>
			</view>
		</view>
      ...
      <!--  <view class="u-margin-top-20 coreshop-bg-white  u-padding-left-20 u-padding-right-20 u-padding-bottom-20" v-if="goodsComments.length">
       ...
       <!-- <view class="u-margin-top-20 coreshop-bg-white coreshop-common-view-box coreshop-goods-shop-info-view-box">
        ...
        <view class="coreshop-good-footer-fixed">
			<view class="buynow" type="success" size="medium" shape="circle" @click="clickHandle()">立即购买</view>
        </view>
