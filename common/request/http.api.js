...
const install = (Vue, vm) => {
	...
	// 观澜接口
    let guanlanArticleList = (params = {}) => vm.$u.post('/api/WqgBlog/ArticleList', params, { method: 'wqgblog.ArticleList', needToken: true });
	// 留言列表
    let msgList = (params = {}) => vm.$u.post('/api/WqgBlog/MsgList', params, { method: 'wqgblog.msgList', needToken: true });
	// 发布留言
    let pubMsg = (params = {}) => vm.$u.post('/api/WqgBlog/Comment', params, { method: 'wqgblog.Comment', needToken: true });
